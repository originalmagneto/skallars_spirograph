...
export default function FooterSettingsManager() {
  ...
  const { layout, updateLayoutSize } = useBentoLayout<'visibility' | 'snapshot'>(
    'admin:footer-settings:bento-layout:v1',
    { visibility: 'lg', snapshot: 'md' }
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
        <AdminSectionCard className={`space-y-3 ${BENTO_SIZE_CLASS[layout.visibility]}`}>
          <div className="flex items-center justify-between gap-2">
            <div className="text-sm font-semibold">Visibility</div>
            <div className="flex items-center gap-2">
              <label htmlFor="footerVisibilitySize" className="text-xs text-muted-foreground">Size</label>
              <select
                id="footerVisibilitySize"
        ...
        <AdminSectionCard className={`space-y-3 ${BENTO_SIZE_CLASS[layout.snapshot]}`}>
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2">
              <label htmlFor="footerSnapshotSize" className="text-xs text-muted-foreground">Size</label>
              <select
                id="footerSnapshotSize"
